...
(function (w) {
  ...
  var FALLBACK = "en";
  var dict = {
    zh: { brand: "全球优选AI导航", hello: "你好，欢迎来到全球优选AI导航", enter: "进入主页", create: "图片 · 视频 · 音乐", search: "搜索工具", home: "首页", tools: "工具", translate: "面对面翻译", more: "更多", hot: "今日热点", all: "全部", loading: "加载中", empty: "没有结果", copy: "复制", open: "打开", rh: "网页出图 · RunningHub", rhsub: "工作流可用 · 有额度", transub: "语音 / 打字 / 拍照", draw: "出图", make: "创作", fraud: "防骗指南", allTools: "全部工具", themeD: "深色", themeL: "浅色", tab_pic: "图片", tab_novel: "小说", tab_movie: "电影", tab_soft: "软件", tab_order: "接单", tab_near: "附近", toolsCount: " 款", hitCount: " 条" },
    en: { brand: "Global AI Directory", hello: "Hello. Welcome to Global AI Directory.", enter: "Enter home", create: "Image · Video · Music", search: "Search tools", home: "Home", tools: "Tools", translate: "Face-to-face translate", more: "More", hot: "Today picks", all: "All", loading: "Loading", empty: "No results", copy: "Copy", open: "Open", rh: "Web Image · RunningHub", rhsub: "Workflow ready", transub: "Voice / type / photo", draw: "Draw", make: "Create", fraud: "Scam guide", allTools: "All tools", themeD: "Dark", themeL: "Light", tab_pic: "Photos", tab_novel: "Novels", tab_movie: "Movies", tab_soft: "Apps", tab_order: "Gigs", tab_near: "Nearby", toolsCount: " tools", hitCount: "" },
    km: { brand: "ថតហកសារ AI សកល", hello: "សួស្តី សូមស្វាគមន៍", enter: "ចូលទំព័រដើម", create: "រូប · វីដេអូ · តន្ត្រី", search: "ស្វែងរកហបករ៎ន៍", home: "ទំព័រដើម", tools: "ឧបករ៎ន៍", translate: "បកប្រែផ្តាំផ្ទាល់មុខ", more: "ផ្សេងទ័ត", hot: "ពេញនិយមថ្ងៃនេះ", all: "ទាងអស់", loading: "កំពុងផ្ទុក", empty: "គ្មានលទ្ធផល", copy: "ចម្លង", open: "បើក", rh: "បង្កើតរូប · RunningHub", rhsub: "មាន workflow", transub: "សំឡេង / វាយ / ថត", draw: "បង្កើតរូប", make: "បង្កើត", fraud: "ការពារក្លែង", allTools: "ឧបករ៎ន៍ទាងអស់", themeD: "ងងឹត", themeL: "ភ្លឺ", tab_pic: "រូប", tab_novel: "ប្រលោមលោក", tab_movie: "ភាពយន្ត", tab_soft: "កម្មវិធី", tab_order: "ការងារ", tab_near: "ក្បែរ", toolsCount: "", hitCount: "" }
  };
  ...
  function t(key) {
    ...
    return (pack && pack[key]) || (dict.en && dict.en[key]) || (dict.zh && dict.zh[key]) || key;
  }
  function apply(root) {
