...
(function (w) {
  ...
  var dict = {
    ...
    km: { brand: "ថតហកសារ AI សកល", hello: "សួស្តី សូមស្វាគមន៍", enter: "ចូលទំព័រដើម", create: "រូប · វីដេអូ · តន្ត្រី", search: "ស្វែងរកហបករ៎ន៍", home: "ទំព័រដើម", tools: "ឧបករ៎ន៍", translate: "បកប្រែផ្តាំផ្ទាល់មុខ", more: "ផ្សេងទ័ត", hot: "ពេញនិយមថ្ងៃនេះ", all: "ទាងអស់", loading: "កំពុងផ្ទុក", empty: "គ្មានលទ្ធផល", copy: "ចម្លង", open: "បើក", rh: "បង្កើតរូប · RunningHub", rhsub: "មាន workflow", transub: "សំឡេង / វាយ / ថត", draw: "បង្កើតរូប", make: "បង្កើត", fraud: "ការពារក្លែង", allTools: "ឧបករ៎ន៍ទាងអស់", themeD: "ងងឹត", themeL: "ភ្លឺ", tab_pic: "រូប", tab_novel: "ប្រលោមលោក", tab_movie: "ភាពយន្ត", tab_soft: "កម្មវិធី", tab_xiaonuan: "ស៊ាវនួន", tab_order: "ការងារ", tab_near: "ក្បែរ", toolsCount: "", hitCount: "" , ft_tip: "ចុចមីក្រូហ្វូននិយាយ រួចផ្ញើ", ft_speak: "និយាយ", ft_photo: "ថត", ft_clear: "សម្អាត", ft_go: "បកប្រែ"}
  };
