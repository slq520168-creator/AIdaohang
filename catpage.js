(function(){
  ...
  var map={
    ...
    movie:{g:'', tags:['电影','短剧','私影','美剧','韩剧'], title:'电影'},
    soft:{g:'pc', tags:[], title:'软件'},
    order:{g:'gig', tags:[], title:'接单'},
    near:{g:'life', tags:['附近','定位','偶遇'], title:'附近'}
  };
  ...
  var t=setInterval(function(){
    n++;
    if(!document.querySelector('#side button')){ if(n>50) clearInterval(t); return; }
    clearInterval(t);
    ...
    setTimeout(function(){
      ...
      document.title=conf.title+' · 全球优选AI导航';
