const I18N={
  zh:{brand:'全球优选AI导航',hot:'今日热门',all:'AI 工具大全',ph:'搜 成人视频 / 图书 / 小说',themeD:'深色',themeL:'浅色',tools:' 款工具',hit:' 条',empty:'没有匹配',res:'搜索结果 '},
  en:{brand:'Global AI Directory',hot:'Trending',all:'All tools',ph:'Search adult video / books / novels',themeD:'Dark',themeL:'Light',tools:' tools',hit:'',empty:'No match',res:'Results '}
};
const CATS=[
...
const KW={
  ...
  '成人':/成人|Fansly|Fanvue|ManyVids|Lovehoney|用品|无审核|成人视频/,
  ...
  '图书':/图书|读书|Kindle|微信读书|Goodreads|听书/,
  '小说':/小说|章纪|人设|Wattpad|连载|纲要/
};
...
async function load(){
  ...
  for(let i=2;i<=107;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=87').then(r=>r.json()).catch(()=>[]);
