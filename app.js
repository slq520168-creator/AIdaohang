...
const KW={
  ...
  '绘画':/绘画/,
  '视频':/视频/,
  '成人':/成人|18|Gleeden|Victoria Milan/,
  '无审核':/无审核/,
  '直播':/直播/,
  '交友':/交友|Gleeden|Ashley Madison/,
  '约炮':/约炮|Gleeden/,
  '办公':/办公/,
  '编程':/编程/,
  '智能工作流':/工作流/,
...
async function load(){
  ...
  for(let i=2;i<=179;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=148').then(r=>r.json()).catch(()=>[]);
