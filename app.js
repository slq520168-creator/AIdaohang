...
const KW={
  ...
  '管理':/管理|ERPNext|Odoo/,
  '绘画':/绘画/,
  '视频':/视频|SadTalker|LivePortrait|MuseTalk/,
  '成人':/成人|18/,
  '无审核':/无审核/,
  '直播':/直播/,
  '交友':/交友/,
  '约炮':/约炮/,
  '办公':/办公|Dify|AnythingLLM|FastGPT|MaxKB|Ragflow/,
  '编程':/编程/,
  '智能工作流':/工作流|n8n|Flowise|Langflow/,
  '游戏':/游戏/,
  '音乐':/音乐/,
  '语音':/语音|OpenVoice|GPT-SoVITS/,
  '设计':/设计/,
  '搜索':/搜索/,
  '写作':/写作/,
  '接单':/接单/,
  ...
  '招聘':/招聘/,
  '社区':/社区/,
  '开店':/开店|WooCommerce|Medusa|Gumroad|Invoice Ninja|Chromis/,
  '小商品':/小商品/,
  '采集':/采集/,
  '接口':/API|Groq|OpenRouter|Cloudflare Workers AI/,
  '机器人':/机器人/,
  '图书':/图书/,
  '小说':/小说/,
  '日韩漫画':/漫画/,
  ...
  '陪聊':/陪聊/,
  '情感':/情感/,
  '端侧':/端侧|Ollama|LM Studio|Jan|GPT4All|MLC/,
  '企业':/企业|Dify|AnythingLLM|MaxKB|Ragflow|Groq/,
  '小商户':/小商户|WooCommerce|Medusa|Gumroad|Invoice Ninja/,
  '食堂':/食堂|Chromis|Floreant|ERPNext|Open Food Facts/,
  '数字人':/数字人|SadTalker|LivePortrait|MuseTalk|OpenVoice/
};
const DROP_NAME=new Set(['Cron Calendar','Brilliant Practice','Quizlet Learn','Tuta Mail','Navidrome Demo','Stream Music','Primephonic 已并','Google Jules Agent','OpenDevin 旧名','Cursor.sh 旧域','Fig Term 已并','Amazon CodeWhisperer','Lyuceum','Mentat AI','Safari 技术预览','Character.AI+','Odakyu? skip']);
...
async function load(){
  ...
  for(let i=2;i<=161;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=130').then(r=>r.json()).catch(()=>[]);
