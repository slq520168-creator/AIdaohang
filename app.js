...
const KW={
  ...
  '健身':/健身/,
  '美妆':/美妆/,
  '宠物':/宠物|explore.org|San Diego Zoo/,
  '美食':/美食/,
  '旅行':/旅行|EarthCam|SkylineWebcams/,
  '拼车':/拼车/,
  '租车':/租车/,
  '法律':/法律/,
  '管理':/管理/,
  '绘画':/绘画/,
  '视频':/视频|Pluto|Plex Live|iPlayer/,
  '成人':/成人|18/,
  '无审核':/无审核/,
  '直播':/直播|EarthCam|webcam|NASA TV|FlightRadar/,
  '交友':/交友/,
  '约炮':/约炮/,
  '办公':/办公/,
  '编程':/编程/,
  ...
  '硬件':/硬件/,
  '隐私':/隐私/,
  '资讯':/资讯|BBC|DW|Al Jazeera|Sky News|Bloomberg|CNBC/,
  '自然':/自然|Windy|explore.org/,
  '棋类':/棋/,
  '家庭':/家庭/,
  '短剧':/短剧/,
  '漫剧':/漫剧/,
  ...
  '日剧':/日剧/,
  '印剧':/印剧/,
  '电视台':/电视台|BBC|NHK World|DW|France 24|Pluto|Plex Live|TV Garden/,
  '监控':/监控|EarthCam|SkylineWebcams|Windy|FlightRadar|MarineTraffic|webcam/
};
...
async function load(){
  ...
  for(let i=2;i<=166;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=135').then(r=>r.json()).catch(()=>[]);
