...
const KW={
  ...
  '无审核':/无审核/,
  '直播':/直播/,
  '交友':/交友|世纪佳缘|百合|珍爱|Meetup Singles/,
  '约炮':/约炮/,
  '办公':/办公/,
  '编程':/编程/,
  '智能工作流':/工作流/,
  ...
  '接单':/接单/,
  '兼职':/兼职/,
  '招聘':/招聘|Indeed|JobStreet|Boss直聘|智联|51Job|Glints/,
  '社区':/社区/,
  '开店':/开店/,
  '小商品':/小商品/,
  '采集':/采集/,
  ...
  '网址':/网址/,
  '认证':/认证/,
  '婚恋':/婚恋|世纪佳缘|百合|珍爱|The Knot|Shaadi/,
  '线下交':/线下交|Meetup Singles|Eventbrite Dating|Timeleft|豆瓣同城/,
  '陪伴租':/陪伴租|租女友|Rental Girlfriend|Ibara/
};
...
async function load(){
  ...
  for(let i=2;i<=178;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=147').then(r=>r.json()).catch(()=>[]);
