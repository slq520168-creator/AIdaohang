const I18N={
  zh:{brand:'全球优选AI导航',hot:'今日热门',all:'AI 工具大全',ph:'搜 人设 / 套图 / 文案 / Civitai / Copy.ai',themeD:'深色',themeL:'浅色',tools:' 款工具',hit:' 条',empty:'没有匹配',res:'搜索结果 '},
  en:{brand:'Global AI Directory',hot:'Trending',all:'All tools',ph:'Search persona photoset copy AI',themeD:'Dark',themeL:'Light',tools:' tools',hit:'',empty:'No match',res:'Results '}
};
const CATS=[
...
const KW={
  ...
  '法律':/法律/,
  '管理':/管理/,
  '绘画':/绘画|Civitai|SeaArt|Leonardo|Artbreeder/,
  '视频':/视频/,
  '成人':/成人|18/,
  '无审核':/无审核/,
  '直播':/直播/,
  ...
  '音乐':/音乐/,
  '语音':/语音/,
  '设计':/设计|Canva|Pinterest/,
  '搜索':/搜索/,
  '写作':/写作|文案|Copy.ai|Jasper|豆包/,
  '接单':/接单/,
  '兼职':/兼职/,
  '招聘':/招聘/,
  '社区':/社区/,
  ...
  '夜生活':/夜生活/,
  '寂寞聊':/寂寞聊/,
  '人设':/人设|CharacterHub|Chub|Artbreeder|Generated Photos/,
  '套图':/套图|Civitai|SeaArt|Tensor Art|Leonardo|Posemy/,
  '文案':/文案|Copy.ai|Jasper|Writesonic|豆包|通义/
};
...
async function load(){
  ...
  for(let i=2;i<=173;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=142').then(r=>r.json()).catch(()=>[]);
