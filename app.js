const I18N={
  zh:{brand:'全球优选AI导航',hot:'今日热门',all:'AI 工具大全',ph:'搜 Copilot / Aider / Cursor / Jules',themeD:'深色',themeL:'浅色',tools:' 款工具',hit:' 条',empty:'没有匹配',res:'搜索结果 '},
  en:{brand:'Global AI Directory',hot:'Trending',all:'All tools',ph:'Search Copilot Aider Cursor Jules',themeD:'Dark',themeL:'Light',tools:' tools',hit:'',empty:'No match',res:'Results '}
};
const CATS=[
...
const KW={
  ...
  '约炮':/约炮/,
  '办公':/办公/,
  '编程':/编程|Copilot|Aider|Cline|Cursor|Windsurf|Jules|Codex|OpenCode|Claude Code|Replit|Bolt|v0|Lovable|GitHub|Git|Codespaces/,
  '智能工作流':/工作流|n8n/,
  '游戏':/游戏/,
  '音乐':/音乐/,
  '语音':/语音/,
...
async function load(){
  ...
  for(let i=2;i<=140;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=115').then(r=>r.json()).catch(()=>[]);
