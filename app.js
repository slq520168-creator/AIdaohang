...
const KW={
  ...
  '美妆':/美妆/,
  '宠物':/宠物/,
  '美食':/美食|菜谱|下厨戾|Allrecipes|Yummly|SuperCook/,
  '旅行':/旅行/,
  '拼车':/拼车/,
  '租车':/租车/,
  '法律':/法律/,
  '管理':/管理/,
  '绘画':/绘画|Unsplash|Pexels|Foodiesfeed|Ideogram|Leonardo/,
  '视频':/视频/,
  '成人':/成人|18/,
  '无审核':/无审核/,
  '直播':/直播/,
  ...
  '音乐':/音乐/,
  '语音':/语音/,
  '设计':/设计|Canva|Photopea|Remove.bg/,
  '搜索':/搜索/,
  '写作':/写作/,
  '接单':/接单/,
  '兼职':/兼职/,
  ...
  '食堂':/食堂/,
  '数字人':/数字人/,
  '厨房':/厨房|ThinQ|Yummly|June Oven|Anova|Meater|Thermomix/,
  '菜谱':/菜谱|Allrecipes|SuperCook|下厨戾|豆果|ChefGPT|DishGen|Mealime/,
  '菜单图':/菜单|Unsplash|Pexels|Foodiesfeed|Canva|Freepik|Openverse|Wikimedia/
};
...
async function load(){
  ...
  for(let i=2;i<=162;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=131').then(r=>r.json()).catch(()=>[]);
