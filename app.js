const I18N={
  zh:{brand:'全球优选AI导航',hot:'今日热门',all:'AI 工具大全',ph:'搜 端侧 / 食堂 / 数字人 / MLC',themeD:'深色',themeL:'浅色',tools:' 款工具',hit:' 条',empty:'没有匹配',res:'搜索结果 '},
  en:{brand:'Global AI Directory',hot:'Trending',all:'All tools',ph:'Search on-device canteen digital human',themeD:'Dark',themeL:'Light',tools:' tools',hit:'',empty:'No match',res:'Results '}
};
const CATS=[
...
const KW={
  '对话':/对话|PocketPal|Maid|ChatterUI/,
  '聊天':/聊天/,
  '插件':/插件/,
  '陪伴':/陪伴/,
  '学习':/学习/,
  ...
  '管理':/管理|Palantir|SAP/,
  '绘画':/绘画/,
  '视频':/视频|HeyGen|Synthesia|智影/,
  '成人':/成人|18/,
  '无审核':/无审核/,
  '直播':/直播/,
  '交友':/交友/,
  '约炮':/约炮/,
  '办公':/办公|Copilot Studio|Salesforce|ServiceNow/,
  '编程':/编程|MLC|llama.cpp|MLX|ExecuTorch/,
  '智能工作流':/工作流/,
  '游戏':/游戏|NVIDIA ACE/,
  '音乐':/音乐/,
  '语音':/语音/,
  ...
  '招聘':/招聘/,
  '社区':/社区/,
  '开店':/开店|Square|Toast|客如云|有赞|微盟/,
  '小商品':/小商品/,
  '采集':/采集/,
  '接口':/API|Bedrock|Azure OpenAI|watsonx|Vertex/,
  '机器人':/机器人/,
  '图书':/图书/,
  '小说':/小说/,
  '日韩漫画':/漫画/,
  ...
  '陪聊':/陪聊/,
  '情感':/情感/,
  '端侧':/端侧|MLC|llama.cpp|MLX|PocketPal|Gemma|MediaPipe|ExecuTorch/,
  '企业':/企业|Azure OpenAI|Bedrock|watsonx|Salesforce|Copilot Studio|SAP|Palantir/,
  '小商户':/小商户|Square|Toast|客如云|二维火|有赞|微盟/,
  '食堂':/食堂|美餐|一卡通|智盘|科密|Kitchen Display/,
  '数字人':/数字人|HeyGen|Synthesia|D-ID|Soul Machines|智影|硅基|NVIDIA ACE/
};
...
async function load(){
  ...
  for(let i=2;i<=160;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=129').then(r=>r.json()).catch(()=>[]);
