const I18N={
  zh:{brand:'全球优选AI导航',hot:'今日热门',all:'AI 工具大全',ph:'搜 语音 / 接口 / 接单',themeD:'深色',themeL:'浅色',tools:' 款工具',hit:' 条',empty:'没有匹配，换个词再试',res:'搜索结果 '},
  en:{brand:'Global AI Directory',hot:'Trending',all:'All tools',ph:'Search voice / API / gigs',themeD:'Dark',themeL:'Light',tools:' tools',hit:'',empty:'No match',res:'Results '}
};
const CATS=[
...
function matchOne(t0,c){
  ...
  if(c==='语音')return t0.cat==='语音'||/语音|配音|TTS|Whisper|Speech|转写|声纹/.test(b);
  ...
  if(c==='接单')return t0.cat==='接单'||t0.pack==='接单'||/接单|威客|约稿|Upwork|Fiverr|猪八戒|电鸭|Gig/.test(b);
