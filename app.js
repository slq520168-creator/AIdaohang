const I18N={
  zh:{brand:'全球优选AI导航',hot:'今日热门',all:'AI 工具大全',ph:'搜 搜索 / 本地模型 / 角色 / 视频',themeD:'深色',themeL:'浅色',tools:' 款工具',hit:' 条',empty:'没有匹配',res:'搜索结果 '},
  en:{brand:'Global AI Directory',hot:'Trending',all:'All tools',ph:'Search local model character video',themeD:'Dark',themeL:'Light',tools:' tools',hit:'',empty:'No match',res:'Results '}
};
const CATS=[
...
const KW={
  '对话':/对话|Chat|Ollama|Open WebUI|LibreChat|Poe|HuggingChat|LM Studio|Jan |GPT4All/,
  '聊天':/聊天|Chat/,
  '插件':/插件/,
  '陪伴':/陪伴|角色|SillyTavern|Character|Janitor|Nomi|Replika/,
  '学习':/学习/,
  '健身':/健身/,
  '美妆':/美妆/,
  '宠物':/宠物/,
  ...
  '法律':/法律/,
  '管理':/管理/,
  '绘画':/绘画|Civitai|SeaArt|Ideogram|Krea|Lexica|Recraft/,
  '视频':/视频|Pika|Luma|Kling|Vidu|Runway|Hedra|HeyGen|D-ID/,
  '成人':/成人|18/,
  '无审核':/无审核|本地|Ollama|Kobold/,
  '直播':/直播/,
  '交友':/交友/,
  '约炮':/约炮/,
  '办公':/办公/,
  '编程':/编程|Phind|Devv|Context7/,
  '智能工作流':/工作流|Dify|Flowise|Langflow|n8n|Gumloop|Ragflow/,
  '游戏':/游戏/,
  '音乐':/音乐/,
  '语音':/语音/,
  '设计':/设计|Recraft/,
  '搜索':/搜索|Perplexity|You.com|Tavily|Exa|Brave Search|SerpAPI/,
  '写作':/写作/,
  '接单':/接单/,
  '兼职':/兼职/,
  '招聘':/招聘/,
  ...
  '开店':/开店/,
  '小商品':/小商品/,
  '采集':/采集|爬|Firecrawl|Scrapy|Playwright|Apify|Jina/,
  '接口':/API|vLLM|llama.cpp/,
  '机器人':/机器人/,
  '图书':/图书/,
  '小说':/小说/,
  '日韩漫画':/漫画/
