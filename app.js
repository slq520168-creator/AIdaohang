...
const KW={
  ...
  '管理':/管理/,
  '绘画':/绘画/,
  '视频':/视频|美剧|韩剧|日剧|印剧|Netflix|Viki/,
  '成人':/成人|18/,
  '无审核':/无审核/,
  '直播':/直播/,
  '交友':/交友/,
  ...
  '情侣房':/情侣房/,
  '附近':/附近/,
  '美剧':/美剧|Hulu|Max|Peacock|Tubi|Paramount|Netflix/,
  '韩剧':/韩剧|Viki|Kocowa|TVING|Wavve|MyDramaList|Viu/,
  '日剧':/日剧|U-NEXT|Abema|TVer|NHK|FOD|Hulu Japan/,
  '印剧':/印剧|Hotstar|JioCinema|SonyLIV|ZEE5|MX Player/
};
...
async function load(){
  ...
  for(let i=2;i<=165;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=134').then(r=>r.json()).catch(()=>[]);
