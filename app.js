...
const KW={
  ...
  '智能工作流':/工作流/,
  '游戏':/游戏/,
  '音乐':/音乐|Suno|Udio|AIVA|BandLab|Moises|Freesound/,
  '语音':/语音|Kits AI|Voice.ai/,
  '设计':/设计/,
  '搜索':/搜索/,
  '写作':/写作/,
  '接单':/接单/,
  ...
  '虚拟信箱':/虚拟信箱/,
  '虚拟馆':/虚拟馆/,
  'AI音乐':/AI音乐|Suno|Udio|AIVA|Soundraw|Boomy|MusicGen|ACE Studio/,
  '音轨':/音轨|分轨|Moises|LALAL|VocalRemover|Fadr/,
  '缩混':/缩混|LANDR|BandLab|Soundtrap|Audiotool|BeepBox/,
  '素材':/素材|Splice|Freesound|BBC Sound|Loopcloud/,
  '翻唱':/翻唱|Kits AI|Voice.ai/
};
...
async function load(){
  ...
  for(let i=2;i<=168;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=137').then(r=>r.json()).catch(()=>[]);
