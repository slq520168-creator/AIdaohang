...
const KW={
  ...
  '招聘':/招聘/,
  '社区':/社区/,
  '开店':/开店|Shopify|Amazon|Etsy|Temu|1688/,
  '小商品':/小商品/,
  '采集':/采集/,
  '接口':/API/,
  '机器人':/机器人/,
  ...
  '套图':/套图/,
  '文案':/文案/,
  '外贸':/外贸|Alibaba|1688|Global Sources|Payoneer|Made-in-China/,
  '铺货':/铺货|CJ Dropshipping|DSers|Spocket|Zendrop|AutoDS|DHgate/,
  '网店':/网店|Shopify|WooCommerce|Etsy|eBay|Amazon Seller|TikTok Shop|Temu/
};
...
async function load(){
  ...
  for(let i=2;i<=174;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=143').then(r=>r.json()).catch(()=>[]);
