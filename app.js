...
const KW={
  ...
  '绘画':/绘画|VRoid|Live2D/,
  '视频':/视频/,
  '成人':/成人|18|Candy AI|DreamGF|Muah/,
  '无审核':/无审核/,
  '直播':/直播|VTuber/,
  '交友':/交友/,
  '约炮':/约炮/,
  '办公':/办公|OpenPhone|信箱/,
  '编程':/编程|Fake GPS|Lockito|Xcode Simulate|Mock Location/,
  '智能工作流':/工作流/,
  '游戏':/游戏|VRChat|Rec Room|Horizon|IMVU/,
  '音乐':/音乐|Wave Virtual/,
  '语音':/语音/,
  '设计':/设计/,
  '搜索':/搜索/,
  ...
  '维修':/维修/,
  '硬件':/硬件/,
  '隐私':/隐私|TextNow|Google Voice|Privacy.com/,
  '资讯':/资讯/,
  '自然':/自然/,
  '棋类':/棋/,
  '家庭':/家庭/,
  ...
  '电视台':/电视台/,
  '监控':/监控/,
  '虚拟定位':/虚拟定位|Fake GPS|Lockito|iAnyGo|Mock Location/,
  '虚拟爱人':/虚拟爱人|Replika|Kindroid|Nomi|Candy AI|DreamGF|Muah/,
  '虚拟人':/虚拟人|VRChat|VRoid|Zepeto|IMVU|Horizon|Live2D/,
  '虚拟号':/虚拟号|TextNow|Google Voice|OpenPhone/,
  '虚拟卡':/虚拟卡|Privacy.com/,
  '虚拟信箱':/虚拟信箱|Anytime Mailbox|iPostal|Traveling Mailbox/,
  '虚拟馆':/虚拟馆|Google Arts|Smithsonian/
};
...
async function load(){
  ...
  for(let i=2;i<=167;i++) files.push('data/more'+i+'.json');
  ...
  const hot=await fetch('data/hot.json?v=136').then(r=>r.json()).catch(()=>[]);
